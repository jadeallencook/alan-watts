(function ($) {
    ...
    $(document).ready(function () {
        ...
        var items, pagination, navigation;
        ...
        if ($mapis.length > 0) {
            ...
            map.addMarker({
                ...
                title: 'Genova',
                infoWindow: {
                    content: '<div class="text-center"><h4 class="font-serif mb-10">121 Somewhere Ave, Suite 123</h4><h5 class="font-alt">P: (000) 111-2222</h5><h5 class="font-alt">Canada</h5></div>'
                }
            });
